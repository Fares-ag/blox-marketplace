...
const origination_analytics_controller_1 = require("./origination-analytics.controller");
...
exports.OpsModule = OpsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [ops_controller_1.OpsController, origination_analytics_controller_1.OriginationAnalyticsController],
    })
], OpsModule);
