...
exports.ISO_NUMERIC_COUNTRIES = exports.QATAR_NUMERIC_CODE = exports.QID_LENGTH = void 0;
exports.normalizeQid = normalizeQid;
exports.parseQid = parseQid;
exports.dateOfBirthMatchesQid = dateOfBirthMatchesQid;
exports.ageFromDateOfBirth = ageFromDateOfBirth;
exports.QID_LENGTH = 11;
exports.QATAR_NUMERIC_CODE = '634';
exports.ISO_NUMERIC_COUNTRIES = {
...
function parseQid(raw, now = new Date()) {
    ...
    if (digits.length !== exports.QID_LENGTH)
    ...
    const nationality = exports.ISO_NUMERIC_COUNTRIES[nationalityCode] ?? null;
    return {
        valid: true,
        qid: digits,
        birthYear,
        nationalityCode,
        nationality,
        residency: nationalityCode === exports.QATAR_NUMERIC_CODE ? 'qatari' : 'expat',
    };
}
function dateOfBirthMatchesQid(dateOfBirth, qid) {
    if (!dateOfBirth)
        return null;
    const parsed = parseQid(qid);
    if (!parsed.valid || parsed.birthYear == null)
        return null;
...
function ageFromDateOfBirth(dateOfBirth, now = new Date()) {
    if (!dateOfBirth)
        return null;
