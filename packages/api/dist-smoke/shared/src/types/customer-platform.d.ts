...
export type CustomerDocumentCategoryDto = 'qid_front' | 'qid_back' | 'passport' | 'driving_licence' | 'residence_proof' | 'salary_certificate' | 'bank_statement' | 'other';
...
export type AssistedSessionStatusDto = 'pending' | 'otp_verified' | 'consents_done' | 'identity_started' | 'completed' | 'expired' | 'cancelled';
